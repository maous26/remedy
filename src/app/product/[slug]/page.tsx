    ...
    <div className="bg-earth-50 min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Image */}
          <div className="aspect-square bg-gradient-to-br from-earth-100 to-sage-100 rounded-2xl overflow-hidden relative">
            {productImages[product.slug] ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Leaf className="h-32 w-32 text-sage-300" />
              </div>
            )}
          </div>
          ...
          <div>
            ...
            <p className="text-lg text-sage-600 mb-4">{product.subtitle}</p>
            ...
            {/* Quick Info */}
            <div className="grid grid-cols-2 gap-4 p-4 bg-white rounded-xl border border-earth-100">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-sage-100 rounded-lg">
                  <MapPin className="h-5 w-5 text-sage-600" />
                </div>
                <div>
                  <p className="text-xs text-earth-500">Origine</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-earth-500">Contenu</p>
                  <p className="text-sm font-medium text-earth-800">
                    {product.weight}
                  </p>
                </div>
          ...
          <div className="bg-white rounded-xl border border-earth-100 p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-gold-100 rounded-lg">
                <Book className="h-5 w-5 text-gold-600" />
              </div>
          ...
          <div className="bg-white rounded-xl border border-earth-100 p-6">
            ...
            <ul className="space-y-2">
              {product.benefits.map((benefit, index) => (
                ...
                >
                  <Leaf className="h-4 w-4 text-sage-500 mt-0.5 flex-shrink-0" />
                  <span>{benefit}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="bg-white rounded-xl border border-earth-100 p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-terracotta-100 rounded-lg">
                <Book className="h-5 w-5 text-terracotta-600" />
              </div>
              <h2 className="text-lg font-semibold text-earth-800">
                Modes d'Utilisation
              </h2>
            ...
            <div className="space-y-4">
              {product.usages.map((usage, index) => (
                <div key={index}>
                  ...
                  <p className="text-sm text-earth-600">{usage.instructions}</p>
                </div>
              ))}
            </div>
          </div>
